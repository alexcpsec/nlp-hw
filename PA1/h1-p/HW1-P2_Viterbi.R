...
e <- function(word, nonterm) {
  ...
  if (is.na(count_words[word])) word = "_RARE_" # rare words, not found in train
...
#writeLines(output_dev, con="gene_dev.p2.out")
...
writeLines(output_test, con="gene_test.p2.out")
